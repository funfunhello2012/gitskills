...
class Spidermaoyan():
	...
	def file_do(self,list_info):
		# 获取文件大小
		file_size = os.path.getsize(r'C:\Git\maoyan.csv')
		if file_size == 0:
			# 表头
			...
			# 数据写入
			file_test.to_csv(r'C:\Git\maoyan.csv', encoding='utf_8_sig', index=False)
		else:
			with open(r'C:\Git\maoyan.csv', 'a+',encoding='utf_8_sig', newline='') as file_test:
				# 追加到文件后面
